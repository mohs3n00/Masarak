...
const CONVERSATIONAL_PATTERNS = [
  ...
  /مين انت/i, /انت مين/i, /انتمين/i, /بترد ازاي/i, /بتشتغل ازاي/i, /^اخبارك/i, /^باي/i, /^سلام/i, 
...
- استخدم اللغة العربية الفصحى للمصطلحات العلمية (مثل المقاومة، الجهد) وتجنب أي لغات أجنبية أو كلمات روسية غير مفهومة.
- **يجب** استخدام تنسيق LaTeX الصحيح لأي معادلات رياضية (استخدم $$ للمعادلات المنفصلة و $ للمعادلات المدمجة). لا تكتب الكسور كنصوص عادية مثل 1/R أبداً بل $\\\\\frac{1}{R}$.

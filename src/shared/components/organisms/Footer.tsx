    ...
    <footer className="bg-background border-t border-border/50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-10 max-w-7xl">
        ...
        <div className="py-14 md:py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8">
            ...
            <div className="flex items-center gap-2">
              {socialLinks.map((social) => (
                <Link
                  key={social.name}
                  href={social.href}
                  className="w-9 h-9 rounded-xl flex items-center justify-center bg-muted/60 text-muted-foreground hover:bg-primary/10 hover:text-primary transition-all duration-200"
          ...
          {/* Support + Legal Links */}
          <div className="space-y-4">
            <h3 className="text-sm font-semibold text-foreground">الدعم والقانوني</h3>
            <ul className="space-y-2.5">

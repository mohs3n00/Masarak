    ...
    <div className="max-w-2xl mx-auto">
      <div className="mb-8">
        <h1 className="text-3xl font-black text-foreground flex items-center gap-3">
          <BookOpen className="w-8 h-8 text-primary" />إنشاء كورس جديد
        </h1>
      </div>
        ...
        <div className="max-w-2xl mx-auto flex items-center justify-between">
          ...
          {step < STEPS.length - 1 ? (
            ...
            <button onClick={handleSubmit} disabled={loading}
              className="flex items-center gap-2 px-6 py-3 rounded-xl bg-success text-white text-sm font-bold shadow-md shadow-success/20 hover:bg-emerald-600 disabled:opacity-50 transition-all">

...
function AccordionContent({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "h-(--accordion-panel-height) px-6 pb-6 pt-0 text-[15px] leading-relaxed data-ending-style:h-0 data-starting-style:h-0 [&_a]:underline [&_a]:underline-offset-3 [&_a]:hover:text-primary",
          className
        )}
      >
        {children}
